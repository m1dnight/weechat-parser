defmodule WeechatParserTest do
  ...
  test "join failed before" do
    line =
      "2018-12-23 18:11:19	-->	hyper-ronin (~hyper-ron@unaffiliated/hyper-ronin) has joined #docker"
  ...
  test "leave double hash" do
    line =
      "2018-12-21 18:38:06	<--	deathwishdave (~deathwish@90.253.191.182) has quit (Client Quit)"
